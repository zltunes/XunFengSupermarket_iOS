...
- (void)setCommentDic:(NSMutableDictionary *)commentDic{
    ...
    _star = [NSString stringWithFormat:@"%@",commentDic[@"stars"]];
    [self showStar];
    
    _commentLab.text = [NSString stringWithFormat:@"%@",commentDic[@"content"]];
    
    _phoneNum.text = [NSString stringWithFormat:@"%@",commentDic[@"phone_num"]];
    
    _dataLab.text = [NSString stringWithFormat:@"%@",commentDic[@"time"]];
