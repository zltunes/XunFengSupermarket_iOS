...
{
    OrderAppDelegate* confirmAppdelegate;
}
...
-(NSArray *)getTimeArray{
    ...
    ConfirmTableViewController* confirm = [[ConfirmTableViewController alloc]init];
    confirm = confirmAppdelegate.naviController_sup.visibleViewController;
    [self setArrayClass:confirm.start_timeStringArr];
    return confirm.start_timeStringArr;
}
